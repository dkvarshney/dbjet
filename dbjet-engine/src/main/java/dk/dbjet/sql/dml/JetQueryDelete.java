...
public class JetQueryDelete extends JetDMLQuery {
	
	private final static String SQL_DELETE = "DELETE FROM %s WHERE %s = ?";
	private Object pkValue;
	
	public JetQueryDelete(Object pkValue, JetModel toModel) {
		super(toModel);
	...
	public PreparedStatement toStatement(Connection con) throws SQLException, JetQueryException {
		...
		PreparedStatement statement = con.prepareStatement(String.format(SQL_DELETE, table, pkColumn.name()));
