...
public final class JetAnyOfSearchAttribute extends JetSearchAttribute {

	private static String CONDITION_PATTERN = "%s IN (%s)";

	public JetAnyOfSearchAttribute(String column, Object value) {
		super(column, value);
